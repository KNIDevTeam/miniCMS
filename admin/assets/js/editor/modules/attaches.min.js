! function(e, t) {
    ...
    return function(e) {
                ...
                f = (i = function(e) {
                    ...
                    switch (e.method) {
                        ...
                        case "UPDATE":
                            ...
                            (u.isFormData(e.data) || u.isFormElement(e.data)) && (n = o.FORM), e.data = l(e.data, n), n !== f.contentType.FORM && (e.headers["content-type"] = n)
                    }
                    return e
                }, l = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    ...
                    transport: function(e) {
                        return e = s(e), u.selectFiles(e).then(function(t) {
                            ...
                            return u.isObject(e.data) && Object.keys(e.data).forEach(function(t) {
                                var r = e.data[t];
                                n.append(t, r)
                            }), e.beforeSend && e.beforeSend(t), e.data = n, a(e)
                        })
                    },
                    selectFiles: function(e) {
                        return delete(e = s(e)).beforeSend, u.selectFiles(e)
                    }
                });
            e.exports = f
        }, function(e, t, n) {
            ...
            var n = function(e) {
                ...
                r = function(e, t, o, i) {
                    return t = t || null, o = o || "&", i = i || null, e ? function(e) {
                        ...
                        var s, c, l = a;
                        if (i && (l = i + "[" + l + "]"), "object" == typeof e[a] && null !== e[a]) s = r(e[a], null, o, l);
                        else {
                            t && (c = l, l = !isNaN(parseFloat(c)) && isFinite(c) ? t + Number(l) : l);
                            var u = e[a];
                            u = (u = 0 === (u = !1 === (u = !0 === u ? "1" : u) ? "0" : u) ? "0" : u) || "", s = n(l) + "=" + n(u)
                        }
                        return s
                    })).join(o).replace(/[!'()*]/g, "") : ""
                };
        ...
        function g(e, t) {
            ...
            if (t.singleton) {
                var a = l++;
                n = c || (c = v(t)), r = x.bind(null, n, a, !1), o = x.bind(null, n, a, !0)
        ...
        var a = function() {
                function e(t) {
                    ...
                    ! function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, e), this.config = n, this.onUpload = r, this.onError = o
                }
                var t, n, r;
                return t = e, (n = [{
        ...
        var y = function() {
            function e(t) {
                ...
                }, this.data = r, this.uploader = new a({
                    config: this.config,
                    onUpload: function(e) {
                        return n.onUpload(e)
                    },
            ...
            return t = e, r = [{
                ...
                value: function() {
                    ...
                    return this.nodes.wrapper = this.make("div", this.CSS.wrapper), this.pluginHasData() ? this.showFileData() : this.prepareUploadButton(), e.appendChild(this.nodes.wrapper), e
                }
            }, {
                key: "prepareUploadButton",
                value: function() {
                    this.nodes.button = this.make("div", [this.CSS.apiButton, this.CSS.button]), this.nodes.button.innerHTML = "".concat(c.a, " ").concat(this.config.buttonText), this.nodes.button.addEventListener("click", this.enableFileUpload), this.nodes.wrapper.appendChild(this.nodes.button)
                }
            }, {
                key: "appendCallback",
                value: function() {
                ...
                value: function(e) {
                    ...
                    if (t.success && t.file) {
                        ...
                        this.data = {
                            ...
                            title: o
                        }, this.nodes.button.remove(), this.showFileData(), this.moveCaretToEnd(this.nodes.title), this.nodes.title.focus(), this.removeLoader()
                    } else this.uploadingFailed(this.config.errorMessage)
                }
            }, {
                key: "appendFileIcon",
                value: function() {
                    ...
                    t && (n.style.color = t, n.setAttribute("data-extension", e)), this.nodes.wrapper.appendChild(n)
                }
            }, {
                key: "removeLoader",
                value: function() {
                ...
                value: function() {
                    ...
                    if (o && (this.nodes.title = this.make("div", this.CSS.title, {
                            contentEditable: !0
                        }), this.nodes.title.textContent = o, i.appendChild(this.nodes.title)), n) {
                        var a, s, c = this.make("div", this.CSS.size);
                        Math.log10(+n) >= 6 ? (a = "MiB", s = n / Math.pow(2, 20)) : (a = "KiB", s = n / Math.pow(2, 10)), c.textContent = s.toFixed(1), c.setAttribute("data-size", a), i.appendChild(c)
                    }
