        ...
        var r = n(1),
            ...
            d = {
                ...
                imgur: {
                    ...
                    html: '<iframe allowfullscreen="true" scrolling="no" id="imgur-embed-iframe-pub-<%= remote_id %>" class="imgur-embed-iframe-pub" style="height: 400px; width: 100%; border: 1px solid #000"></iframe>',
                    height: 500,
                    width: 540
                },
                gfycat: {
