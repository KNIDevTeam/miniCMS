...
! function(t, e) {
    ...
    return function(t) {
                    ...
                    value: function(t) {
                        return new Promise(function(e, n) {
                            ...
                            r.type = "file", t.multiple && r.setAttribute("multiple", "multiple"), t.accept && r.setAttribute("accept", t.accept), r.addEventListener("change", function(n) {
                                for (var r = n.target.files, o = new FormData, i = 0; i < r.length; i++) o.append(t.fieldName, r[i], r[i].name);
                                t.beforeSend(r), e(o)
                            }, !1), r.click()
                        })
                    }
        ...
        if (r.regeneratorRuntime = void 0, t.exports = n(12), o) r.regeneratorRuntime = i;
        else try {
